...
import {ColumnW as Column, Container, Rate, SetColor, TableW as Table} from "../../../component";
import {data} from "../ManyFilter/data/Data";
import {N4} from "../../../utils/format";

function FlowContainer(props) {
    return <Container header={`TableW组件测试——${data.length}条`} nopad style={{maxHeight:300}}>
