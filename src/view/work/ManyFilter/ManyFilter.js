...
function ManyFilter(props) {
    return <Container header='多重筛选' nopad>
        ...
        <TableW data={data.slice(0,100)}>
            ...
            <Column width={110} align='right' bind='pnlPctAll' text='自成立收益率' convert={v=>numFormat(v,'N4')}/>
            <Column width={110} align='right' bind='volAll' text='自成立波动率' convert={v=>numFormat(v,'N4')}/>
            <Column width={118} align='right' bind='sharpeAll' text='自成立夏普比率' convert={v=>numFormat(v,'N4')}/>
            <Column width={110} align='right' bind='pnlPctY1' text='近一年收益率' convert={v=>numFormat(v,'N4')}/>
            <Column width={110} align='right' bind='volY1' text='近一年波动率' convert={v=>numFormat(v,'N4')}/>
